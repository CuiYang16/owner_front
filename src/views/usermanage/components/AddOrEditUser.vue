    ...
    <el-dialog title="用户信息" :visible.sync="dialogVisible" width="40%">
      <el-form :model="userDialogRow" size="mini">
        <el-form-item label="用户名" :label-width="formLabelWidth">
          <el-input v-model="userDialogRow.userName" autocomplete="off" />
        </el-form-item>
        <el-form-item label="性别" :label-width="formLabelWidth">
          <el-select v-model="userDialogRow.userSex" placeholder="请选择性别">
        ...
        <el-form-item label="联系方式" :label-width="formLabelWidth">
          <el-input v-model="userDialogRow.userPhone" autocomplete="off" />
        </el-form-item>
        <el-form-item label="邮箱" :label-width="formLabelWidth">
          <el-input v-model="userDialogRow.userEmail" autocomplete="off" />
        </el-form-item>
